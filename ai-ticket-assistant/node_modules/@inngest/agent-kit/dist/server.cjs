...
var import_inngest9 = require("inngest");
...
var createServer = ({
  ...
  const inngest = client != null ? client : new import_inngest9.Inngest({ id: appId });
  ...
  for (const agent of agents) {
    const slug = (0, import_inngest9.slugify)(agent.name);
    const id = `agent-${slug}`;
  ...
  for (const network of networks) {
    const slug = (0, import_inngest9.slugify)(network.name);
